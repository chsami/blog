...
> ⚠️ **IMPORTANT: When creating new blog posts, ALWAYS use these exact colors from `index.html`.**
> Copy the CSS variables below into the new post's `<style>` block to maintain visual consistency.
